...
- [x] The Add Movie page should have the buttons:
...
- [x] `Save` button, which should update the title and description and one genre in the database and bring the user to the Details Page
